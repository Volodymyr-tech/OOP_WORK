...
def test_average_salary():
    ...
    emp4 = Vacancies("NODE", "https://hh.ru/vacancy/108435856", "Зарплата от 100 до 100 USD", "работай больше")
    salary = emp4.average_salary()
    assert salary == 100


def test_ln():
    emp1 = Vacancies("NODE", "https://hh.ru/vacancy/108435856", "Зарплата от 100 до 100 USD", "работай больше")
    emp2 = Vacancies("Python", "https://hh.ru/vacancy/1025", "Зарплата от 200 до 200 USD", "работай больше")
    return emp1 <= emp2
